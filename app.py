...
# Title of the app
st.title("Bank Data Analysis on CSV Files")
...
def configuration_content():
    ...
    api_key_input = st.text_input("OpenAI API Key", value=st.session_state[sk-OsMMq65tXdfOIlTUYtocSL7NCsmA7CerN77OkEv29dODg1EA], type="password")
